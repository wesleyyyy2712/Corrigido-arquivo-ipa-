...
- Imported patch packages appear in **Installed** with a switch: turning it on applies the patch, and turning it off restores the original files. See [the iPhone-only GitHub build guide](docs/GITHUB_BUILD_PT-BR.md) for the manual workflow.
